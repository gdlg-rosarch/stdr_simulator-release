...
## stdr_simulator (indigo) - 0.3.2-0

The packages in the `stdr_simulator` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo stdr_simulator` on `Mon, 06 Feb 2017 08:32:11 -0000`
...
## stdr_simulator (kinetic) - 0.3.1-0

The packages in the `stdr_simulator` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release stdr_simulator --track kinetic --rosdistro kinetic --new-track` on `Mon, 18 Jul 2016 18:36:05 -0000`
...
## stdr_simulator (jade) - 0.3.1-0

The packages in the `stdr_simulator` repository were released into the `jade` distro by running `/usr/bin/bloom-release stdr_simulator --track jade --rosdistro jade` on `Mon, 18 Jul 2016 18:16:32 -0000`
...
## stdr_simulator (indigo) - 0.3.1-0

The packages in the `stdr_simulator` repository were released into the `indigo` distro by running `/usr/bin/bloom-release stdr_simulator --track indigo --rosdistro indigo` on `Mon, 18 Jul 2016 18:03:10 -0000`
...
## stdr_simulator (indigo) - 0.2.0-0

The packages in the `stdr_simulator` repository were released into the `indigo` distro by running `/usr/bin/bloom-release stdr_simulator --track indigo --rosdistro indigo --new-track` on `Mon, 13 Oct 2014 13:34:13 -0000`
